...
//   return (
//     <tr
//       style={{ borderBottom: '1px solid rgba(10,92,138,.08)' }}
...
//         style={{
//           padding: '0.9rem 1.25rem',
//           color: highlight ? 'var(--teal)' : 'var(--ink-mid)',
//           fontSize: '0.875rem',
...
//       style={{
//         background: 'linear-gradient(135deg,#0A5C8A,#00869B)',
//       }}
//     >
//       <div
//         style={{
...
//           inset: 0,
//           background:
//             'radial-gradient(ellipse at 30% 40%,rgba(0,196,212,.2) 0%,transparent 55%)',
//           pointerEvents: 'none',
//         }}
//       />
...
//             animation: 'spin-mol-a 18s linear infinite',
//           }}
//         >
//           <circle
//             cx="170"
...
//           style={{
//             transformOrigin: '170px 130px',
//             animation: 'spin-mol-b 26s linear infinite reverse',
//           }}
//         >
//           <circle
//             cx="170"
...
//             r="70"
//             fill="none"
//             stroke="rgba(0,196,212,.2)"
//             strokeWidth="1"
//           />
//         </g>

//         <polygon
//           points="170,80 215,105 215,155 170,180 125,155 125,105"
//           fill="none"
...
//         style={{
//           background: 'white',
//           borderBottom: '1px solid rgba(10,92,138,.1)',
//         }}
//       >
//         <div
//           className="max-w-7xl mx-auto px-6 md:px-16 py-4 flex items-center gap-2 text-sm"
...
//             style={{
//               borderRight: '1px solid rgba(10,92,138,.1)',
//             }}
//           >
//             {/* badges */}
//             <div className="flex flex-wrap gap-2 mb-5">
...
//             {/* quick specs */}
//             <div
//               className="grid grid-cols-2 sm:grid-cols-3 gap-px rounded-xl overflow-hidden mb-8"
//               style={{
//                 background: 'rgba(10,92,138,.1)',
//                 border: '1px solid rgba(10,92,138,.1)',
//               }}
//             >
//               {[
//                 ['CAS Number', product.cas],
...
//                   boxShadow: '0 6px 20px rgba(10,92,138,.35)',
//                   border: 'none',
//                   cursor: 'pointer',
//                   fontFamily: 'Plus Jakarta Sans, sans-serif',
//                 }}
...
//                 style={{
//                   background:
//                     'linear-gradient(90deg,rgba(0,134,155,.08),rgba(10,92,138,.05))',
//                   borderBottom:
//                     '1px solid rgba(10,92,138,.1)',
//                 }}
//               >
//                 <span
//                   style={{
...
//                   }}
//                 >
//                   SRRD Laboratories provides
//                   comprehensive Safety Data Sheets (SDS)
//                   for all compounds in compliance with
//                   GHS/OSHA requirements.
//                 </p>
//               </div>
//             )}
...
//                         [
//                           'Documentation',
//                           'CoA and supporting analytical data available',
//                         ],
//                       ].map(([k, v]) => (
//                         <tr
//                           key={String(k)}
...
//                   [
//                     '1. Definitions',
//                     'Seller means SRRD LABORATORIES including affiliates and authorised representatives. Buyer means entity placing an order. Products include chemicals, impurities, intermediates, isotope-labelled compounds and deliverables.',
//                   ],
//                   [
//                     '2. Scope of Agreement',
//                     'These Terms & Conditions govern all quotations, orders, supplies and services provided by the Seller.',
//                   ],
//                   [
//                     '3. Quotations & Orders',
//                     'Quotations are valid for 30 days unless stated otherwise. Orders become binding only after written acceptance.',
//                   ],
//                   [
//                     '4. Pricing & Payment Terms',
//                     'Prices exclude taxes, duties and shipping unless specified. Late payments may incur 2% monthly interest.',
//                   ],
//                   [
//                     '5. Delivery & Risk',
//                     'Delivery terms are EXW unless otherwise agreed. Risk transfers upon dispatch.',
//                   ],
//                   [
//                     '6. Product Quality & Specifications',
//                     'Products conform to agreed specifications or internal release criteria.',
//                   ],
//                   [
//                     '7. Inspection & Claims',
//                     'Buyer must inspect products within 7 days of receipt.',
//                   ],
//                   [
//                     '8. Use & Regulatory Compliance',
//                     'Products are supplied for research and development use only.',
//                   ],
//                   [
//                     '9. Intellectual Property',
//                     'All methods and proprietary technologies remain exclusive property of the Seller.',
//                   ],
//                   [
//                     '10. Confidentiality',
...
//                     'Seller liability is limited to value of affected Product or Service.',
//                   ],
//                   [
//                     '12. Force Majeure',
//                     'Seller is not liable for delays caused by events beyond reasonable control.',
//                   ],
//                   [
//                     '13. Returns & Disposal',
...
//                     'Governed by laws of Telangana, India. Disputes resolved in Hyderabad courts.',
//                   ],
//                   [
//                     '16. Miscellaneous',
//                     'No amendment valid unless in writing signed by both parties.',
//                   ],
//                 ].map(([title, text]) => (
//                   <div
//                     key={title}
...
//                     }}
//                   >
//                     Select your required pack size and
...
//                       <button
//                         type="submit"
//                         className="flex items-center gap-2 px-6 py-3 rounded-lg text-white font-bold text-sm self-start"
//                         style={{
//                           background: 'var(--grad-btn)',
//                           border: 'none',
//                           cursor: 'pointer',
...
//                   key={r.id}
//                   href={`/products/${r.id}`}
//                   className="flex flex-col rounded-[12px] overflow-hidden no-underline transition-all hover:-translate-y-1"
//                   style={{
//                     background: 'white',
//                     border:
//                       '1.5px solid rgba(10,92,138,.12)',
...
/* ── atom colour map ────────────────────────── */
const ATOM_COLORS: Record<string, { fill: string; label: string }> = {
  C: { fill: '#4A90D9', label: 'Carbon' },
  H: { fill: '#A8D8EA', label: 'Hydrogen' },
  N: { fill: '#00C4D4', label: 'Nitrogen' },
  O: { fill: '#E07B5A', label: 'Oxygen' },
  S: { fill: '#F5C542', label: 'Sulfur' },
  F: { fill: '#6BCB77', label: 'Fluorine' },
  Cl: { fill: '#A7C96E', label: 'Chlorine' },
  Br: { fill: '#C47F4F', label: 'Bromine' },
  P: { fill: '#E88E5A', label: 'Phosphorus' },
  Na: { fill: '#9B59B6', label: 'Sodium' },
  K: { fill: '#8E44AD', label: 'Potassium' },
  Ca: { fill: '#95A5A6', label: 'Calcium' },
  Mg: { fill: '#1ABC9C', label: 'Magnesium' },
  Fe: { fill: '#E74C3C', label: 'Iron' },
  Zn: { fill: '#7F8C8D', label: 'Zinc' },
};

/* ── formula parser ─────────────────────────── */
function parseFormula(formula: string): { element: string; count: number }[] {
  // Strip leading/trailing whitespace and dots (e.g. "·HCl" portions)
...
function ComponentStructure({ formula }: { formula: string }) {
  const atoms = parseFormula(formula);
  const total = atoms.reduce((s, a) => s + a.count, 0);

  // SVG layout: arrange atoms in a radial/bubble chart
  const cx = 170;
  const cy = 120;
  const maxR = 90;

  // Scale bubble radius by count (min 10, max 38)
  const maxCount = atoms[0]?.count ?? 1;
  const bubbleR = (count: number) =>
    Math.max(10, Math.min(38, 10 + (count / maxCount) * 28));

  // Place bubbles in a circle; first (largest) goes center
  const positions: { x: number; y: number; el: string; count: number }[] = [];
  if (atoms.length === 0) return null;

  // Centre atom
  positions.push({ x: cx, y: cy, el: atoms[0].element, count: atoms[0].count });

  const rest = atoms.slice(1);
  rest.forEach((a, i) => {
    const angle = (2 * Math.PI * i) / rest.length - Math.PI / 2;
    const dist = maxR - bubbleR(a.count) * 0.3;
    positions.push({
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* bubbles */}
        {positions.map((p) => {
          const r = bubbleR(p.count);
          const col = ATOM_COLORS[p.el] ?? { fill: '#AAAAAA', label: p.el };
          return (
            <g key={p.el}>
              <circle
                cx={p.x}
        ...
        <text
          ...
          letterSpacing="1.5"
        >
          {total} ATOMS · {atoms.length} ELEMENTS
        </text>
      </svg>
      ...
      <div
        ...
        style={{ borderTop: '1px solid rgba(255,255,255,.1)', paddingTop: '0.6rem' }}
      >
        {atoms.map((a) => {
          const col = ATOM_COLORS[a.element] ?? { fill: '#AAAAAA', label: a.element };
          return (
            <div key={a.element} className="flex items-center gap-1">
              <span
                style={{
                  width: 8,
                  height: 8,
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-16 grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-0">
          ...
          {/* Right */}
          <div className="py-12 pl-0 lg:pl-10 flex flex-col gap-5">
            <ComponentStructure formula={product.formula} />
